...
public class PresentationPage extends WizardPage {
	 ...
	 * Create the wizard.
	 */
	public PresentationPage(String title, String apType, String elements, String genericDescription,
			WizardPage stepByStep, WizardPage optionPage) {
		super(title);
		...
		setTitle(title);
		setDescription("This Wizard will help you decide if the occurrence of the " + apType
				+ " antipattern characterizes an error.");
	}
	...
	public void createControl(Composite parent) {
		...
		lblModelElements.setText("The combination of the following elements characterize an occurence of the " + apType
				+ " antipattern:");
		...
		gl_container.setHorizontalGroup(gl_container.createParallelGroup(GroupLayout.LEADING)
				.add(gl_container.createSequentialGroup()
						...
						.add(gl_container.createParallelGroup(GroupLayout.LEADING)
								.add(lblModelElements, GroupLayout.DEFAULT_SIZE, 552, Short.MAX_VALUE).add(
										combinationText, GroupLayout.DEFAULT_SIZE, 552, Short.MAX_VALUE))
						.add(11))
				.add(gl_container.createSequentialGroup().addContainerGap()
						...
						.addContainerGap())
				.add(gl_container.createSequentialGroup().addContainerGap()
						.add(descriptionText, GroupLayout.DEFAULT_SIZE, 552, Short.MAX_VALUE).addContainerGap())
				.add(gl_container.createSequentialGroup().addContainerGap()
						.add(gl_container.createParallelGroup(GroupLayout.LEADING)
		...
		gl_container.setVerticalGroup(gl_container.createParallelGroup(GroupLayout.LEADING).add(gl_container
				.createSequentialGroup().add(13).add(lblModelElements).addPreferredGap(LayoutStyle.RELATED)
				.add(combinationText, GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
				.addPreferredGap(LayoutStyle.RELATED).add(lblAntipatternDescripton).addPreferredGap(LayoutStyle.RELATED)
				.add(descriptionText, GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
				.addPreferredGap(LayoutStyle.RELATED).add(lblWouldYouLike).add(8).add(btnGoWizard).add(8)
				.add(btnGoOptions).add(11)));
		container.setLayout(gl_container);
	}

	@Override
	public IWizardPage getNextPage() {
		if (btnGoOptions.getSelection())
			return optionPage;
		else if (btnGoWizard.getSelection())
			return stepByStep;
		else
