...
public class PatternManager extends AbstractManager {
    ...
    private PatternManager() {
        if (PatternLoader.INSTANCE != null) throw new IllegalStateException("PatternManager already instantiated");
    }		
	 ...
	 *  Users must override this method to get the modifications made by the patterns */
