 ...
 *
 */
public class AbstractionProjectUIController {

	public void createAbstractionDiagram(List<AbstractionOccurrence> occurrencies, String padrao) {
		...
		for (AbstractionOccurrence o : occurrencies) {
	...
	public void createAbstractionsHTML(HashMap<String, List<AbstractionOccurrence>> occurrenciesAbstractions) {
		...
		Iterator<Entry<String, List<AbstractionOccurrence>>> it = occurrenciesAbstractions.entrySet().iterator();
		while (it.hasNext()) {
			Entry<String, List<AbstractionOccurrence>> pair = it.next();
			padrao = (String) pair.getKey();
			occurrencies = (List<AbstractionOccurrence>) pair.getValue();
	...
	public void createAbstractionPlantUML(HashMap<String, List<AbstractionOccurrence>> occurrenciesAbstractions) {

		List<AbstractionOccurrence> occurrencies = null;

		List<Element> allOccurrenciesElements;

		for (String chave : occurrenciesAbstractions.keySet()) {
			occurrencies = new ArrayList<AbstractionOccurrence>();
			for (Map.Entry<String, List<AbstractionOccurrence>> par : occurrenciesAbstractions.entrySet()) {
				if (par.getKey() == chave) {
