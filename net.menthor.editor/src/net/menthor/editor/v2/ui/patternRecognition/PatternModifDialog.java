 ...
 */
public class PatternModifDialog extends Dialog {
	 ...
	 */
	public PatternModifDialog(Shell parentShell) {
		super(parentShell);
	}

	public PatternModifDialog(Shell parentShell, Fix fix, JFrame frame) {
		super(parentShell);
		this.fix = fix;
		this.frame = frame;
	}
	...
	public static int openDialog(final Fix fix, final JFrame frame) {
		...
		PatternModifDialog resultDialog = new PatternModifDialog(shell, fix, frame);
		resultDialog.create();
