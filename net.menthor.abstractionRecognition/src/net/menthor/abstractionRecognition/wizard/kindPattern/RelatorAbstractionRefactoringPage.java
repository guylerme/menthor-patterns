...
public class RelatorAbstractionRefactoringPage extends RefactoringPage {

	public RelatorAbstractionOccurrence asscyc;
	 ...
	 * Create the wizard.
	 */
	public RelatorAbstractionRefactoringPage(RelatorAbstractionOccurrence asscyc) {
		super();
		this.asscyc = asscyc;

		setTitle(RelatorAbstraction.getAbstractionInfo().acronym + " Refactoring Options");
		setDescription("The follwing options can be used to refactor the model.");
	}

	public RelatorAbstractionWizard getAssCycWizard() {
		return (RelatorAbstractionWizard) getWizard();
	}
	...
	public IWizardPage getNextPage() {
		((RelatorAbstractionWizard) getWizard()).removeAllActions();
		...
		if (btnDerive.getSelection() && assocCombo.getSelectionIndex() >= 0) {
			...
			// Action =============================
			RelatorAbstractionAction newAction = new RelatorAbstractionAction(asscyc);
		...
		return ((RelatorAbstractionWizard) getWizard()).getFinishing();
	}
}
