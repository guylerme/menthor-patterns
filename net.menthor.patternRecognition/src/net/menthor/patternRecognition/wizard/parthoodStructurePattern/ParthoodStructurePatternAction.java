...
public class ParthoodStructurePatternAction extends PatternAction<ParthoodStructureOccurrence> {

	public Association assoc;

	public ParthoodStructurePatternAction(ParthoodStructureOccurrence ap) {
		super(ap);
	}
