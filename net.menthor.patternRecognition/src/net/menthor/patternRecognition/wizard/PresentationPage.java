...
public class PresentationPage extends WizardPage {
	 ...
	 * Create the wizard.
	 */
	public PresentationPage(String title, String ptrn, String elements, String genericDescription) {
		super(title);
		...
		setTitle(title);
		setDescription("This Wizard will help you create a new diagram to represent " + ptrn + " pattern.");
	}
