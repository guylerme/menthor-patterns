...
public class SubstanceSortalPatternAction extends PatternAction<SubstanceSortalOccurrence> {

	public Association assoc;

	public SubstanceSortalPatternAction(SubstanceSortalOccurrence ap) {
		super(ap);
	}
