...
public class NonSortalPatternRefactoringPage extends RefactoringPage {

	public NonSortalOccurrence nonSortal;
	 ...
	 * Create the wizard.
	 */
	public NonSortalPatternRefactoringPage(NonSortalOccurrence nonSortal) {
		super();
		this.nonSortal = nonSortal;

		setTitle(NonSortalPattern.getPatternInfo().acronym + " Refactoring Options");
		setDescription("The follwing options can be used to refactor the model.");
	}

	public NonSortalPatternWizard getAssCycWizard() {
		return (NonSortalPatternWizard) getWizard();
	}
	...
	public IWizardPage getNextPage() {
		((NonSortalPatternWizard) getWizard()).removeAllActions();

		if (btnEnforce.getSelection()) {
			// Action =============================
			NonSortalPatternAction newAction = new NonSortalPatternAction(nonSortal);
		...
		return ((NonSortalPatternWizard) getWizard()).getFinishing();
	}
}
